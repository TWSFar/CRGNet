...
class DeepLab(nn.Module):
    def __init__(self, opt):
        ...
        self.aspp = ASPP(opt.backbone, opt.output_stride, self.backbone.high_outplanes, BatchNorm)
        self.link_conv = nn.Sequential(nn.Conv2d(
            self.backbone.high_outplanes, 128, kernel_size=1, stride=1, padding=0, bias=False))
